Epoch 80/100
782/782 [==============================] - 16s 20ms/step - loss: 0.9475 - acc: 0.6639
Epoch 81/100
782/782 [==============================] - 16s 20ms/step - loss: 0.9405 - acc: 0.6677
Epoch 82/100
 49/782 [>.............................] - ETA: 16s - loss: 0.9310 - acc: 0.6725
...
class MyNet:
    ...
    def build(input_shape=INPUT_SHAPE, classes=NB_CLASSES):
        model = Sequential()
        for n, filters in enumerate([32,64,128,256,512]):
